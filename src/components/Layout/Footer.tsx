    ...
    <footer className="bg-gradient-to-l from-teal-800 to-teal-600 text-white rounded-t-3xl shadow-2xl relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="flex flex-col md:flex-row justify-between">
          ...
          {/* Wrapper for Quick Links, Services, Locations, and Contact Us */}
          <div className="w-full md:w-4/5 flex flex-col md:flex-row">
            ...
            <div className="w-full md:w-1/4 mb-8 md:mb-0">
              ...
              <ul className="space-y-2 text-sm text-gray-300">
                <li><FooterLink to="/shalimar-bagh">Shalimar Bagh</FooterLink></li>
                <li><FooterLink to="/ashok-vihar">Ashok Vihar</FooterLink></li>
                <li><FooterLink to="/patel-nagar">Patel Nagar</FooterLink></li>
                <li><FooterLink to="/adarsh-nagar">Adarsh Nagar</FooterLink></li>
                <li><FooterLink to="/kirti-nagar">Kirti Nagar</FooterLink></li>
              </ul>
            </div>
          </div>
        </div>
