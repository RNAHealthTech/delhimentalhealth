...
export default function ExperienceShowcaseList(
  ...
  return (
    <div className="mx-auto my-40 max-w-7xl px-6 sm:px-14 md:my-60 md:px-20">
      <h2 className="text-gray-500 md:mb-30 mb-16 w-full bg-gradient-to-r from-accent/70 to-accent bg-clip-text text-center text-3xl font-bold xs:text-4xl sm:text-6xl md:text-8xl">
        {props.title}
      </h2>
